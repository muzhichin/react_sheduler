...
(function () {/*
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
    var g = window, h = document, m = g.location, n = function () {
    }, q = /\[native code\]/, u = function (a, b, c) {
        return a[b] = a[b] || c
    }, aa = function (a) {
        a = a.sort();
        ...
        var a;
        if ((a = Object.create) && q.test(a)) a = a(null); else {
            a = {};
    ...
    var da = /^(\/[a-zA-Z0-9_\-]+)+$/, O = [/\/amp\//, /\/amp$/, /^\/amp$/], ea = /^[a-zA-Z0-9\-_\.,!]+$/,
        fa = /^gapi\.loaded_[0-9]+$/, ha = /^[a-zA-Z0-9,._-]+$/, la = function (a, b, c, d) {
            var e = a.split(";"), f = e.shift(), l = L[f], k = null;
        ...
        Q = function (a, b, c) {
            ...
            return null
        }, ka = /^https?:\/\/[a-z0-9_.-]+\.google(rs)?\.com(:\d+)?\/[a-zA-Z0-9_.,!=\-\/]+$/, ja = /\/cb=/g,
        ia = /\/\//g, oa = function () {
            var a = B();
    ...
    var R = decodeURI("%73cript"), S = /^[-+_0-9\/A-Za-z]+={0,2}$/, T = function (a, b) {
        ...
        k = u(C(c), "r", []).sort();
        var H = u(C(c), "L", []).sort(), E = [].concat(k), W = function (a, b) {
            if (y) return 0;
            g.clearTimeout(x);
            H.push.apply(H, p);
